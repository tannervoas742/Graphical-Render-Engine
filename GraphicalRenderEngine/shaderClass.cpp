...
void Shader::StoreShader(std::string Tag)
{
	MyTag = Tag;
	Shader::LoadedShaders[Tag] = this;
}
...
void Shader::compileErrors(unsigned int shader, const char* type)
{
	...
	if (type != "PROGRAM")
	{
		...
		if (hasCompiled == GL_FALSE)
		{
			...
			COUT(std::format("SHADER_COMPILATION_ERROR for: {}\n{}", type, infoLog));
		}
	}
	else
	{
		...
		if (hasCompiled == GL_FALSE)
		{
			...
			COUT(std::format("SHADER_LINKING_ERROR for: {}\n{}", type, infoLog));
		}
	}
}